...
public class RestConfig {
    ...
    public static final RestConfig gusREST = new RESTAppBuilder().client_id("3MVG92.uWdyphVj6UxPnhEXcGWPpVRheELsx9An.CZdCuUVSiepPic6SwD6b59JXDtrfbkCkJRDtQZJc_n6dN").redirect_uri("https://zxu-wsl:8443/EvaluationNewsFeedFiltering/home.jsp").client_secret("9014937268783936461").tokenURL("https://gus.salesforce.com/services/oauth2/token").authURL("https://gus.salesforce.com/services/oauth2/authorize").build();
    public static final RestConfig currentREST = gusREST;
